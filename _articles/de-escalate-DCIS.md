...
title: "An Immunohistochemistry-based Decision Flowchart to De-escalate Axillary Surgery for Biopsy-Diagnosed Pure Ductal Carcinoma In Situ (DCIS) of the Breast"
authors:
  - given: "Ewe Seng"
    family: "Ch'ng"
...
background: >-
  ...
  neoplastic epithelial cells remain confined within the ductal-lobular system.
...
evidence:
  - source: "Riggi et al. (2026); retrospective cohort of 258 DCIS lesions (252 patients)"
    finding: "Forty-two of 258 DCIS (16%) were upstaged in the subsequent resection (26% pT1mi, 38% pT1a, 19% pT1b, 10% pT1c, 5% pT2, 2% pT3). Only 5 of 144 SLNBs (3%) were positive, and all axillary lymph node metastases were associated with a mammary IBC diagnosis. Of 38 SLNBs performed in upstaged DCIS, none of the 8 associated with pT1mi upstaging had nodal metastasis."
    limitation: "Retrospective single-institution design with potential selection bias; missing data on clinical presentation (11%) and medical imaging (3–14%); the correlation between radiological and final DCIS size was significant but many lesions were radiologically overestimated or underestimated."
  - source: "Riggi et al. (2026); univariate and multivariate analyses of upstaging predictors"
    finding: "In univariate analysis, symptomatic presentation (P = .014), radiological size >20 mm (P = .025), smaller biopsy surface (P = .011, the smaller the biopsy surface the higher the risk), lack of histological calcifications (P = .005), and solid architecture (P = .013) were significantly associated with upstaging. After correction for biopsy surface, dichotomous radiological size, and solid architecture, only postoperative DCIS size (P = .009) remained significant. Two-tier and three-tier nuclear grade, necrosis, TILs, stromal architecture, ER, PR, and HER2 were not significantly associated with upstaging."
...
open_questions:
  ...
  - "Whether PR expression adds any prognostic information to ER status for the purpose of axillary de-escalation, as current data suggest it does not."
  - "How to handle the 6 to 10% of DCIS that remain unclassified by the current models because of missing data or absent features."
  - "Whether the immunohistochemical profile of biopsy-diagnosed DCIS reliably predicts the profile of occult synchronous IBC across larger and more diverse cohorts."

perspective: >-
  This study addresses a genuine clinical contradiction: patients with DCIS
  are frequently subjected to axillary staging despite guidelines recommending
  it only for those treated with mastectomy, and despite the finding that
  ...
  grading, known to be prone to interobserver variability, was deliberately
  excluded. The finding that a smaller biopsy surface correlates with higher
  upstaging risk is biologically plausible—less tissue sampled means a greater
  chance of missing a microinvasive component—and supports the clinical
  intuition that biopsy adequacy matters. The proposed flowchart is a
  hypothesis-generating instrument, not a guideline, and its authors
  appropriately call for retrospective multicenter validation before
  prospective trials. If validated, however, it could meaningfully reduce
